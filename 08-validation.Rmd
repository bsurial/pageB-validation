...
ggsave(plot = kaplan_15y_cc, here("graphs", "08-kaplan-meier_15y.png"), 
       dpi = 300, bg = "white", 
       width = 6, height = 5)
```
...
were missing.
We use multiple imputaiton for this. 
...
write_rds(imp_data, here("processed", "08-imputed_data.rds"))
```

```{r read-impute-data, eval=!params$impute}
imp_data <- read_rds(here("processed", "08-imputed_data.rds"))
```
...
# Assess imputation
png(file = here("graphs", "08-imputation_density.png"),
...
ggsave(here("graphs", "08-kaplan_meyer_15y_imp.png"), 
       dpi = 300, bg = "white", 
       width = 6, height = 5)
...
ggsave(plot = p_combined_h, 
       filename = here("graphs", "08-kaplan_combined.png"), 
       dpi = 300, bg = "white", width = 10, height = 5)

ggsave(plot = p_combined_h, 
       filename = here("graphs", "08-kaplan_combined.pdf"), 
       dpi = 300, bg = "white", width = 10, height = 5, 
       device = cairo_pdf)

ggsave(plot = p_combined_v, 
       filename = here("graphs", "08-kaplan_combined_v.png"), 
       dpi = 300, bg = "white", width = 8, height = 10)

ggsave(plot = p_combined_v, 
       filename = here("graphs", "08-kaplan_combined_v.pdf"), 
       dpi = 300, bg = "white", width = 8, height = 10, 
       device = cairo_pdf)


ggsave(plot = pp$table, 
       filename = here("graphs", "08-kaplan_risktable.pdf"),
...
```{r write-out}
write_rds(time_sub, here("processed", "08-studypop.rds"))
write_rds(imp_long, here("processed", "08-imp_long_df.rds"))
```
